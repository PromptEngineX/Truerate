...
GOLD_COLOR = ("#B8860B", "#B8860B") # Keep gold for the button
...
class LoginPage(customtkinter.CTk):
    def __init__(self):
        ...
        # Custom themes are best loaded from JSON, but we'll set colors directly for this
        customtkinter.set_default_color_theme("blue") # Keep default as 'blue' but override where needed
...
class MainApplication(customtkinter.CTk):
    def __init__(self):
        ...
        customtkinter.set_appearance_mode("dark")
        customtkinter.set_default_color_theme("blue") # Keep default, but apply custom colors explicitly
    ...
    def _setup_live_rates_tab(self):
        ...
        self.news_textbox = customtkinter.CTkTextbox(news_panel, wrap="word", height=100, fg_color=ACCENT_GRAY, text_color=TEXT_COLOR)
    ...
    def _setup_recent_orders_tab(self):
        ...
        # Placeholder for a data table of recent orders
        orders_table_frame = customtkinter.CTkFrame(recent_orders_frame, fg_color=ACCENT_GRAY, corner_radius=10, border_width=1, border_color=NEON_RED_DARK)
        orders_table_frame.grid(row=0, column=0, sticky="nsew", padx=10, pady=10)
        customtkinter.CTkLabel(orders_table_frame, text="[ Placeholder for Recent Orders Data Table ]", font=customtkinter.CTkFont(size=18), text_color="gray70").pack(expand=True, fill="both", padx=20, pady=20)
        ...
        self.update_recent_orders() # Initial display
    ...
    def _setup_currency_diff_tab(self):
        ...
        self.currency_usd_inr_label = customtkinter.CTkLabel(currency_diff_frame, text="USD/INR: Loading...", font=customtkinter.CTkFont(size=16), text_color=TEXT_COLOR)
        ...
        self.currency_eur_inr_label = customtkinter.CTkLabel(currency_diff_frame, text="EUR/INR: Loading...", font=customtkinter.CTkFont(size=16), text_color=TEXT_COLOR)
        ...
        self.currency_gbp_inr_label = customtkinter.CTkLabel(currency_diff_frame, text="GBP/INR: Loading...", font=customtkinter.CTkFont(size=16), text_color=TEXT_COLOR)
    ...
    def update_recent_orders(self):
        ...
        # For this example, we'll just display the initial dummy data
        # In a real app, you might iterate and create CTkLabels or use a CTkTable widget
        recent_orders_frame = self.tab_view.tab("Recent Orders")
    ...
    def place_order(self):
        ...
        self.recent_orders_data.append({
            "ID": new_order_id,
            "Type": order_type,
            "Metal": metal_type,
            "Qty": quantity,
    ...
    def simulate_new_order_data(self):
        ...
        metals = ["Gold", "Silver"]
        types = ["Buy", "Sell"]
        quantities = ["5g", "1oz", "20g", "50oz"]
        prices = ["6600 INR/g", "82 INR/g", "Market"]
